...
<?php
    ...
    if (isset($_GET['id'])) {
        ...
        echo "<a href='actu.php' class='mx-auto flex rounded border-0 bg-indigo-500 py-2 px-8 text-lg text-white hover:bg-indigo-600 focus:outline-none'> return </a>";
    }
    else {
            ...
            foreach ($news as $news) {
                ...
                $card = "
                     <div class='flex justify-start gap-4 w-1/2 bg-gray-900 p-4 rounded-lg shadow-md'>
                        <a href='actu.php?id={$cpt}' class='flex items-center gap-4 w-full max-w-lg p-4 rounded-lg shadow-md''>
